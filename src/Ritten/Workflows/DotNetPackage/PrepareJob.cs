...
/// </summary>
internal sealed class PrepareJob : DotNetPackageJob
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    protected override void Configure(IWorkflowBuilder builder, DotNetPackageSettings settings, JobArguments args)
    {
