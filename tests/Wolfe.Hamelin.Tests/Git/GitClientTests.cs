...
namespace Wolfe.Hamelin.Tests.Git;
...
{
    private readonly string _repository = Directory.CreateTempSubdirectory("wolfe-hamelin-git-").FullName;
    private readonly string _remote = Directory.CreateTempSubdirectory("wolfe-hamelin-git-remote-").FullName;
